/** Open Finance OpenAPI specification for Finicity APIs. Open Finance (formerly
  * Open Banking) solutions in the US are provided by Finicity, a Mastercard
  * company.
  *
  * The version of the OpenAPI document: 1.38.3 Contact:
      ...
      authConfig match
        ...
        case Authorization.ApiKey(apiKey) =>
          location match
            ...
            case ApiKeyLocation.NOAPIKEY => request
