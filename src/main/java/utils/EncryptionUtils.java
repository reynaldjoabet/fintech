...
//import static example.utils.concat;
//import static example.utils.EncodingUtils.base64Decode;
...
public final class EncryptionUtils {
    ...
    public static PrivateKey loadDecryptionKey(InputStream keyDataStream) throws GeneralSecurityException, IOException {
        ...
        if (keyDataString.contains(PKCS_1_PEM_HEADER)) {
            ...
            return null;//readPkcs1PrivateKey(base64Decode(keyDataString));
        }
        ...
        if (keyDataString.contains(PKCS_8_PEM_HEADER)) {
            ...
            keyDataString = keyDataString.replace("\n", "");
            keyDataString = keyDataString.replace("\r", "");
            return null;//readPkcs8PrivateKey(base64Decode(keyDataString));
        }
    ...
    private static PrivateKey readPkcs1PrivateKey(byte[] pkcs1Bytes) throws GeneralSecurityException {
        ...
        byte[] pkcs8bytes = null; //concat(pkcs8Header, pkcs1Bytes);
